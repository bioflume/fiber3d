...
class tstep(object):
  ...
  def time_step_hydro(self, dt, *args, **kwargs):
    ...
    if True:
      ...
      self.fibers, self.fibers_gone, self.bodies, self.num_nucleated, self.num_nucleated_imaginary, self.sites_gone_imaginary, self.terminal_time_gone_imaginary, self.site_idcs_nucleating, self.site_idcs_dying = tstep_utils.dynamic_instability_v2(self.fibers,
                                                                 self.bodies,
                                                                 self.prams,
                                                                 self.options,
                                                                 self.dt,
