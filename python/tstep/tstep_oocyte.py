...
class tstep(object):
  ...
  def __init__(self, prams, options, fibers, bodies, molecular_motors):
    ...
    if True:
      # Build shape
      normals_periphery = -prams.cortex_norms
      nodes_periphery = prams.cortex_xyz
      h_periphery = None
      gradh_periphery = None
      self.periphery_points = prams.cortex_xyz
      self.periphery_normals = -prams.cortex_norms
