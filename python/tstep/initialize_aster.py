...
class set_parameters(object):
  def __init__(self, eta = 1.0,
               ...
               cortexV_flow_direction = None,
               cortexV_strength = None,
               cortexV_flow_normal = None,
               cortex_sites_file = None,
               cortex_fibers_file = None,
               centrosome_position = None,
    ...
    self.cortexV_strength = cortexV_strength
    self.cortexV_flow_direction = cortexV_flow_direction
    self.cortexV_flow_normal = cortexV_flow_normal
...
def initialize_from_file(input_file,options,prams):
  ...
  if False: #read.molecular_motor_config is not None:
