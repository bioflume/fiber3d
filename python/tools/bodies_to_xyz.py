...
# from multi_fibers import multi_fiber
...
if __name__ == '__main__':
  ...
  # Create rigid bodies
  structures = read.structures + read.structures_body_fibers
  bodies = []
  body_types = []
  num_blobs_ID = 0
    ...
    for step in range(n_steps // n_save + 1): 
      ...
      for k, b in enumerate(bodies):
        if b.ID == name_ID:
          ...
          b.orientation = quaternion.Quaternion([float(data[3]), float(data[4]), float(data[5]), float(data[6])])
