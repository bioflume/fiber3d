...
class Body(object):
  ...
  def discretize_body_ellipsoid(self, Nblobs = 800, a = 2, b = 2, c = 6):
    '''
    Discretize the rigid body with Nblobs points, shape can be sphere or anything else in the shape_gallery.py
    '''
    ...
    self.reference_configuration, self.reference_normals, h_body, gradh_body = shape_gallery.shape_gallery('ellipsoid', self.Nblobs, a = 2, b = 2, c = 6)
