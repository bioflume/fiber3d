...
def gmres(A, b, x0=None, tol=1e-05, atol=0, restart=None, maxiter=None, xtype=None, M=None, callback=None, restrt=None, PC_side='right'):
  '''
  ...
  if PC_side == 'left' or M is None:
    return scspla.gmres(A, b, M=M, x0=x0, tol=tol, atol=atol, maxiter=maxiter, restart=restart, callback=callback)
  ...
  (y, info) = scspla.gmres(APinv_partial_LO, b, x0=x0, tol=tol, atol=atol, maxiter=maxiter, restart=restart, callback=callback) 
