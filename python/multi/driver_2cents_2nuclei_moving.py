...
if __name__ == '__main__':
  ...
  output_name = 'data/twoNuclei_twoCents/' + sys.argv[1] + '/run'
  len_nuc2nuc = float(sys.argv[2])
  scale_nuc2nuc = float(sys.argv[3])
  ...
  prams = initialize.set_parameters(eta = 0.1, 
                                    epsilon = 1e-03, 
                                    final_time = 2000, 
                                    fiber_body_attached = True,
                                    len_nuc2nuc = len_nuc2nuc,
                                    scale_nuc2nuc = scale_nuc2nuc)
