...
if __name__ == '__main__':
  ...
  if grow_mts:
    ...
    filename = './jaySims/Structures_Nov26/radius16/run'
    ...
    input_file = './jaySims/input_files_Dec7/radius16_resume.inputfile'
    filename = './jaySims/data_Dec7/radius16/run'
    repulsion = True
    ...
    active_sites_idcs_file = './jaySims/data_Nov26/radius16/run-centrosome_at_center_active_site_idcs.clones'
    passive_sites_idcs_file = './jaySims/data_Nov26/radius16/run-centrosome_at_center_passive_site_idcs.clones'
    fib_attached_to_body_file = './jaySims/data_Nov26/radius16/run_centrosome_at_center_attached_to_body.fibers'
    fib_nuc_site_idx_file = './jaySims/data_Nov26/radius16/run_centrosome_at_center_nuc_site_idx.fibers'
    fib_length_before_die_file = './jaySims/data_Nov26/radius16/run_centrosome_at_center_length_before_die.fibers'
    dt = 5E-3
    dt_max = 1E-2
    time_max = None
  Nfiber = 32
