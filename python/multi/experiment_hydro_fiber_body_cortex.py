...
if __name__ == '__main__':
  ...
  input_file = './input_files/fiber_body_cortex.inputfile'
  
  read = read_input.ReadInput(input_file)
  
  useFMM = True # flag for using FMM
  n_time_steps = 250000
  Nfiber = 32
  Nbody = 200 #1200, 4000
  Nperiphery = 2000 # 8000, 10000
  body_quad_radius = 0.4
  dt = 5E-3
  filename = 'data/fiber_body_cortex/run'
  ...
  prams = initialize.set_parameters(eta = 10.0, 
      epsilon = 1e-03,
      Efib = 0.1,
      final_time = n_time_steps*dt,
