...
if __name__ == '__main__':
  ...
  filename = '/mnt/ceph/users/gkabacaoglu/oocyteData/mts_on_oocyte_normal_coarse_resume/run'
  fiber_resume = '/mnt/ceph/users/gkabacaoglu/oocyteData/mts_on_oocyte_normal_coarse/run_fibers_resume.fibers'

  cortex_file = './eggShape.mat'
  cortex_file2 = './eggShape.mat'
