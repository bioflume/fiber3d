...
if __name__ == '__main__':
  ...
  filename = '/mnt/ceph/users/gkabacaoglu/streamingSphere/velocity/run'
  fiber_resume = '/mnt/ceph/users/gkabacaoglu/streamingSphere/simulation4/run_centrosome_at_x0_resume.fibers'

  periphery = 'sphere' #'sphere' # shape of the periphery, could be 'sphere' or 'ellipsoid'
  periphery_radius = 1.04 * 5
  mt_surface_radius = 5
  ...
  radius_xp, radius_xm = 5, -5
  radius_yp, radius_ym = 5, -5
  radius_zp, radius_zm = 5, -5
