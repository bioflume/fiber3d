...
import sys
sys.path.append('../')
from tstep import tstep_cancel as tstep
...
if __name__ == '__main__':
  ...
  #filename = './jaySims/data_set' + str(int(set)) + '_new/radius' + str(int(radius)) + '_' + str(resume_step) + '/run'
  filename = '/mnt/ceph/users/gkabacaoglu/JayAsterRotation/data_set' + str(int(set)) + '/radius' + str(int(radius)) + '_' + str(resume_step) + '/run'
