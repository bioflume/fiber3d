...
if __name__ == '__main__':
  ...
  if grow_mts:
    ...
    filename = './jaySims/data/large_confinement_grow/run'
    repulsion = False
    ...
    input_file = './jaySims/input_files/large_confinement_resume.inputfile'
    filename = './jaySims/data/large_confinement/run'
    repulsion = True
    ...
    active_sites_idcs_file = './jaySims/Structures/large_conf_resume/run-centrosome_at_center_active_site_idcs.clones'
    passive_sites_idcs_file = './jaySims/Structures/large_conf_resume/run-centrosome_at_center_passive_site_idcs.clones'
    fib_attached_to_body_file = './jaySims/Structures/large_conf_resume/run_centrosome_at_center_attached_to_body.fibers'
    fib_nuc_site_idx_file = './jaySims/Structures/large_conf_resume/run_centrosome_at_center_nuc_site_idx.fibers'
    fib_length_before_die_file = './jaySims/Structures/large_conf_resume/run_centrosome_at_center_length_before_die.fibers'
