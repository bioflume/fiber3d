...
if __name__ == '__main__':
  ...
  filename = '/mnt/ceph/users/gkabacaoglu/oocyteData/sphereRuns/SAMPLES/' + sys.argv[1] + '/run' + sys.argv[5] + '/run'
  ...
  random_seed = sys.argv[5] # initialization of rng
  ...
  Nmts_gradient_along_axis = 'uniform' # or None
