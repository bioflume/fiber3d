...
if __name__ == '__main__':
  ...
  radius = 15
  filename = './jaySims/data_set15/radius15_' + str(resume_step) + '/run'
  ...
  if resume_step is not None:
    ...
    occupied_sites_idcs_file = '/mnt/ceph/users/gkabacaoglu/time_series_set15/radius' + str(radius) +'/occupied_site_idcs.step' + str(resume_step)
    active_sites_idcs_file = '/mnt/ceph/users/gkabacaoglu/time_series_set15/radius' + str(radius) + '/active_nuc_site_idcs.step' + str(resume_step)
    passive_sites_idcs_file = '/mnt/ceph/users/gkabacaoglu/time_series_set15/radius' + str(radius) + '/passive_nuc_site_idcs.step' + str(resume_step)
    fib_sites_lengths_file = '/mnt/ceph/users/gkabacaoglu/time_series_set15/radius' + str(radius) + '/fiber_lengths.step' + str(resume_step)
    site_idcs_nucleating_file = '/mnt/ceph/users/gkabacaoglu/time_series_set15/radius' + str(radius) + '/site_info_nucleating.txt'
    site_idcs_dying_file = '/mnt/ceph/users/gkabacaoglu/time_series_set15/radius' + str(radius) + '/site_info_dying.txt'
    site_idcs_hinged_file = '/mnt/ceph/users/gkabacaoglu/time_series_set15/radius' + str(radius) + '/site_info_hinged.txt'
  else:
