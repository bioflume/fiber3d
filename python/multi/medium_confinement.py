...
if __name__ == '__main__':
  ...
  # 4x: nuc_rate = 30, 2x: nuc_rate = 15, x: nuc_rate = 7.5
  ...
  if grow_mts:
    ...
    filename = './jaySims/data/medium_conf_4x_grow/run'
    repulsion = False
    ...
    input_file = './jaySims/input_files/medium_confinement_resume.inputfile'
    filename = './jaySims/data/medium_conf_2/run'
    repulsion = True
    ...
    active_sites_idcs_file = './jaySims/Structures/medium_resume2/run-centrosome_at_center_active_site_idcs.clones'
    passive_sites_idcs_file = './jaySims/Structures/medium_resume2/run-centrosome_at_center_passive_site_idcs.clones'
    fib_attached_to_body_file = './jaySims/Structures/medium_resume2/run_centrosome_at_center_attached_to_body.fibers'
    fib_nuc_site_idx_file = './jaySims/Structures/medium_resume2/run_centrosome_at_center_nuc_site_idx.fibers'
    fib_length_before_die_file = './jaySims/Structures/medium_resume2/run_centrosome_at_center_length_before_die.fibers'
