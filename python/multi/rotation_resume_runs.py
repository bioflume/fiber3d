...
if __name__ == '__main__':
  ...
  if resume_step is not None:
    info = np.loadtxt('./jaySims/data_set' + str(set) + '_new/radius' + str(int(radius)) + '_' + str(resume_step) + '/run_time_system_size.txt', dtype = np.float64)
    resume_from_step = resume_step + int(info[-1,2])
    occupied_sites_idcs_file = './jaySims/data_set' + str(set) + '_new/radius' + str(int(radius)) + '_' + str(resume_step) + '/run-centrosome_at_center_occupied_site_idcs.clones'
    active_sites_idcs_file = './jaySims/data_set' + str(set) + '_new/radius' + str(int(radius)) + '_' + str(resume_step) + '/run-centrosome_at_center_active_site_idcs.clones'
    passive_sites_idcs_file = './jaySims/data_set' + str(set) + '_new/radius' + str(int(radius)) + '_' + str(resume_step) + '/run-centrosome_at_center_passive_site_idcs.clones'
    fib_sites_lengths_file = './jaySims/data_set' + str(set) + '_new/radius' + str(int(radius)) + '_' + str(resume_step) +  '/run_centrosome_at_center_nuc_site_idx.fibers'
    ...
    body_file = './jaySims/data_set' + str(set) + '_new/radius' + str(int(radius)) + '_' + str(resume_step) + '/run_centrosome_at_center_resume.clones'
    fibers_file ='./jaySims/data_set' + str(set) + '_new/radius' + str(int(radius)) + '_' + str(resume_step) + '/run_centrosome_at_center_resume.fibers'
